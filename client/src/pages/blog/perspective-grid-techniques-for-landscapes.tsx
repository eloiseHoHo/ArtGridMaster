...
export default function PerspectiveGridTechniquesForLandscapes() {
  return (
    <>
      <Helmet>
        <title>Perspective Grid Techniques for Landscape Painting | PhotoGrid.space</title>
        <meta 
          name="description" 
          content="Master perspective in landscape art with our guide to grid techniques. Learn how to capture depth, distance, and scale in your landscape paintings and drawings."
        />
        {/* Open Graph tags */}
        ...
        {/* Keywords */}
        <meta name="keywords" content="perspective grid, landscape painting, landscape drawing, one-point perspective, two-point perspective, horizon line, vanishing point, landscape art, depth in landscapes" />
      </Helmet>
