...
export default function GridMethodForPerfectPortraits() {
  return (
    <>
      <Helmet>
        <title>How to Use Grid Method for Perfect Portraits | PhotoGrid.space</title>
        <meta 
          name="description" 
          content="Learn how to master the grid method for portrait drawing with our step-by-step guide. Achieve perfect proportions and create stunning portrait artwork easily."
        />
        {/* Open Graph tags */}
      ...
      <main className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex items-center mb-6">
            ...
            />
            <div>
              <div className="font-medium text-gray-900">Michael Adams</div>
              <div className="text-sm text-gray-500">Professional Portrait Artist & Instructor</div>
            </div>
          </div>
        </div>
