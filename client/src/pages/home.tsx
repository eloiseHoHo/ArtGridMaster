        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 bg-gray-50">
          ...
          <div className="mb-20 bg-white rounded-2xl shadow-md p-8 border border-gray-100">
            ...
            <div className="prose max-w-none">
              <p className="text-lg">
                A <strong>photo grid</strong> is one of the most powerful
                techniques an artist can use to improve accuracy and proportion
                in their drawings and paintings. By overlaying a grid on a
                reference photo, artists can focus on one section at a time,
                making complex subjects more manageable and ensuring correct
                proportions.
              </p>
              <p className="text-lg">
                At PhotoGrid, we've revolutionized the traditional{" "}
                <strong>photo grid</strong> method by offering digital tools
                that create customized grid overlays instantly. Whether you're a
                beginner learning to draw or a professional artist working on
                commissioned portraits, our <strong>photo grid</strong>{" "}
                transformations will enhance your artistic process.
              </p>
              <h3 className="text-2xl font-semibold mt-8 mb-4 text-gray-800">
                Benefits of Using Photo Grid Techniques
              </h3>
              <ul className="space-y-3">
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Improved Accuracy</strong> - Break down complex
                    images into manageable sections for better precision
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>
                    <strong>Perfect Proportions</strong> - Maintain correct
                    proportions throughout your artwork
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>
                    <strong>Simplified Complexity</strong> - Make challenging
                ...
                <li className="flex items-start">
                  ...
                  <span>
                    <strong>Scale with Ease</strong> - Easily transfer images to
                    different sizes while maintaining proportions
                  </span>
                </li>
                <li className="flex items-start">
                  <svg
                  ...
                  <span>
                    <strong>Enhanced Learning</strong> - Train your artistic eye
                    as you work with the grid reference
                  </span>
                </li>
              </ul>
              <p className="text-lg mt-6">
                Our <strong>photo grid</strong> tools offer customizable options
                including grid density, color, opacity, and style. We've also
                developed specialized grid transformations for different subject
                matters like portraits, landscapes, and still life.
              </p>
