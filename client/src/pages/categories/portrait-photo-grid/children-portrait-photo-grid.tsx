...
export default function ChildrenPortraitPhotoGrid() {
  ...
  return (
    <>
      <Helmet>
        <title>Children Portrait Photo Grid: Kids Drawing Reference for Artists | PhotoGrid</title>
        <meta 
          name="description" 
          content="Transform children's portrait photos into perfect grid references for drawings and paintings. Our Children Portrait Photo Grid tool helps artists capture accurate facial proportions and youthful features."
        />
        {/* Open Graph tags */}
        ...
        <meta property="og:url" content="https://photogrid.app/categories/portrait-photo-grid/children-portrait-photo-grid" />
        {/* Canonical URL */}
        <link rel="canonical" href="https://photogrid.app/categories/portrait-photo-grid/children-portrait-photo-grid" />
      </Helmet>
