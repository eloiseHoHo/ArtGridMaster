              ...
              <>
                {!isUrlMode ? (
                  ...
                  >
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400 mt-1">JPG, PNG up to 10MB</p>
                  </div>
                ) : (
                ...
                <div className="flex items-center gap-2 mt-3">
                  <button
                    ...
                    className="text-xs text-gray-500 dark:text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 flex items-center gap-1"
                  >
                ...
                <div className="mt-3">
                  <p className="text-xs text-gray-500 dark:text-gray-400 mb-2">Or try a sample:</p>
