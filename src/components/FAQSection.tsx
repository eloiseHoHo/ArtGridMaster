...
const faqs = [
  ...
  { q: "Is PhotoGrid.space really 100% free?", a: "Yes, all 7 tools are completely free with no usage limits, no signup required, no watermarks, and no hidden fees. We believe artist tools should be accessible to everyone." },
  ...
  { q: "What tools does PhotoGrid.space offer?", a: "PhotoGrid.space offers 7 free tools: Grid Overlay for proportional drawing, Line Art converter, Pencil Sketch effect, Coloring Page generator, Paint by Numbers creator, Pixel Art converter, and Watercolor & Oil Painting effects." },
