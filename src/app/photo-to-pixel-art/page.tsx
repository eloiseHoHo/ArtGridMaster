...
export const metadata: Metadata = {
  title: "Photo to Pixel Art Converter | Free Online",
  description: "Turn any photo into pixel art online. Choose pixel size, color palette, and 8-bit or retro styles, then download PNG. Free, no signup, no watermark.",
  keywords: [
    "photo to pixel art",
    "pixel art converter",
    "image to pixel art",
  ...
  alternates: { canonical: "https://photogrid.space/photo-to-pixel-art" },
  openGraph: {
    title: "Photo to Pixel Art Converter | Free Online",
    description: "Turn photos into pixel art online with adjustable pixel size, color palette, and retro styles. Free, no signup, no watermark.",
    url: "https://photogrid.space/photo-to-pixel-art",
  },
};
...
export default function PhotoToPixelArt() {
  return (
    <>
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({"@context":"https://schema.org","@type":"WebApplication","name":"Photo to Pixel Art Converter","url":"https://photogrid.space/photo-to-pixel-art","description":"Free online tool to convert photos into retro pixel art","applicationCategory":"DesignApplication","operatingSystem":"Web","offers":{"@type":"Offer","price":"0","priceCurrency":"USD"},"aggregateRating":{"@type":"AggregateRating","ratingValue":"4.8","ratingCount":"1670"}}) }} />
      ...
      <main>
        ...
        <RelatedTools currentTool="pixelart" />
      </main>
    </>
  );
}
